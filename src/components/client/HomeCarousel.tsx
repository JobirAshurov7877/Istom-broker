          ...
          <div className="pt-10 flex-col gap-6 flex  md:flex-row justify-between items-start ">
            <div className="grid grid-cols-12 max-w-[300px]">
              ...
              <div className="col-span-9">
                <h3 className="text-[16px] font-bold">Сотрудничество</h3>
            ...
            <div className="grid grid-cols-12 max-w-[300px]">
              ...
              <div className="col-span-9">
                <h3 className="text-[16px] font-bold">Быстрая доставка</h3>
                <p className="text-[#000000CC] text-[14px] mt-2 leading-normal">
                  Отправляем заказы в течение 1-2 рабочих дней, бесплатная
                  доставка от 2000 ₽
                </p>
              </div>
            </div>
            <div className="grid grid-cols-12 max-w-[300px]">
              ...
              <div className="col-span-9">
                <h3 className="text-[16px] font-bold">Качество</h3>
                <p className="text-[#000000CC] text-[14px] mt-2 leading-normal">
