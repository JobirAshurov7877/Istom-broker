      ...
      <div className="grid lg:grid-cols-12 gap-10">
        <div className=" lg:col-span-5">
          ...
          <form action="" className="mt-4">
            ...
            <div className="mt-4">
              <label htmlFor="number" className="text-[14px] md:text-[18px] text-[#00000080]">
                Ваш номер <span className="text-[#FF6565]">*</span>
              </label>
              <input
                type="text"
                name="number"
            ...
            <div className="mt-4">
              <label htmlFor="запрос" className="text-[14px] md:text-[18px] text-[#00000080]">
                Ваш запрос
              </label>
              <textarea
                name="запрос"
